...
class GenerateCommand extends DependencyLicenseCommand
{
    ...
    protected function configure()
    {
        $this
            ...
            ->addOption('full', 'f', InputOption::VALUE_OPTIONAL, 'Show full license text', false);
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $this->generateLicensesText($dependencies, $input->getOption('full'));
     ...
     * @return void
     */
    protected function generateLicensesText($dependencies, bool $showFull = false)
    {
        $text = $this->getBoilerplate();

        foreach ($dependencies as $dependency) {
            $text .= $this->getTextForDependency($dependency, $showFull);
        }
...
';
     ...
     * @return string
     */
    protected function getTextForDependency($dependency, bool $showFull = false)
    {
        ...
        $license =  $showFull ? $this->getFullLicenseText($name): null;
